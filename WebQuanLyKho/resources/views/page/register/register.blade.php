...
<head>
    ...
    <title>CloudStock | Register</title>
                        ...
                        <div class="p-20 content-bottom">
                            ...
                            <form novalidate>
                                ...
                                <div class="form-group">
                                    <div class="controls">
                                        <div class="input-group mb-3">
                                           <input type="password" name="password2" data-validation-match-match="password" class="form-control" required="" aria-invalid="true" placeholder="Xác nhận mật khẩu">
                                            <div class="input-group-prepend">
                            ...
                            <div class="text-center">
                                <p class="mb-0 mt-10">Tôi đã có tài khoản<a href="login" class="text-info ml-5">Đăng nhập</a></p>
                            </div>
                        </div>
                    </div>
                </div>
