    ...
    var defaults = {
                ...
                return this.each(function () {
                    ...
                    if (settings.options.sniffHtml) {
                        ...
                        if ($this.attr("minlength") !== undefined) {
                            message = "Quá ngắn: Vui lòng nhập trên " + $this.attr("minlength") + " kí tự<!-- data-validation-minlength-message to override -->";
                        ...
                        if ($this.attr("type") !== undefined && $this.attr("type").toLowerCase() === "email") {
                            message = "Vui lòng nhập đúng mail";
        ...
        , validatorTypes: {
            ...
            , required: {
                name: "required"
                , init: function ($this, name) {
                    var message = "Vui lòng không bỏ trống";
                    if ($this.data("validation" + name + "Message")) {
                        message = $this.data("validation" + name + "Message");
                    }
                    return {
            ...
            , match: {
                ...
                , init: function ($this, name) {
                    ...
                    var message = "Mật khẩu không trùng khớp";
                    var $label = null;
            ...
            , minlength: {
                ...
                , init: function ($this, name) {
                    ...
                    result.message = "Quá ngắn: Vui lòng nhập " + result.minlength + " kí tự";
                    if ($this.data("validation" + name + "Message")) {
                        result.message = $this.data("validation" + name + "Message");
                    }
                    return result;
        ...
        , builtInValidators: {
            ...
            , required: {
                name: "Required"
                , type: "required"
                , message: "Vui lòng không bỏ trống<!-- data-validator-required-message to override -->"
            }
            , checkone: {
                name: "Checkone"
                , type: "minchecked"
